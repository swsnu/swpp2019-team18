...
export const GET_ALL_GARDEN_DIARY = 'GET_ALL_GARDEN_DIARY'
export const GIVE_FLOWER = 'GIVE_FLOWER'
export const GET_GARDEN_DIARY_BY_CATEGORY = 'GET_GARDEN_DIARY_BY_CATEGORY'
export const GET_MY_GARDEN_DIARY = 'GET_MY_GARDEN_DIARY'
export const SET_GARDEN_MODE = 'SET_GARDEN_MODE'
